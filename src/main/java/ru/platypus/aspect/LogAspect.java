...
public class LogAspect {
    ...
    @Before("@annotation(ru.platypus.annotation.LogBeforeMethod)")
    ...
    @Around("@annotation(ru.platypus.annotation.LogExecutionTime)")
    ...
    @AfterThrowing(pointcut = "@annotation(ru.platypus.annotation.LogException)", throwing = "ex")
    ...
    @AfterReturning(pointcut = "@annotation(ru.platypus.annotation.LogResult)", returning = "result")
